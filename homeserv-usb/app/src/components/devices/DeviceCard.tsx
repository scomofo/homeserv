  ...
  return (
    ...
    >
      ...
      {device.type === "sensor" ? (
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() =>
                  onControl("set_temperature", {
                    temperature: (targetTemp || 20) - 0.5,
                  })
                }
        ...
        // Light, switch, fan, cover, media_player — toggle
        <div className="space-y-2">
          <button
          ...
          {device.type === "light" && on && brightness !== undefined && (
