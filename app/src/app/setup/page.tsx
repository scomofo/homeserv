    ...
    <div className="min-h-screen flex items-center justify-center warm-gradient p-4">
      <div className="warm-card p-8 w-full max-w-sm animate-fade-in-up">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-slate-800 dark:text-slate-100">HomeServ Setup</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Create your admin account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="confirm" className="block text-sm font-medium text-slate-600 dark:text-slate-300 mb-1">
              Confirm Password
            </label>
            <input
              id="confirm"
